...
public class SummaryDetailsResBean {
    ...
    public SummaryDetailsResBean(double win_money, double retreat, double balance, String no, String detail, String game_name, int money, String count, String game_code, String round, String rate, String time) {
        this.win_money = win_money;
        this.retreat = retreat;
        this.balance = balance;
        this.no = no;
