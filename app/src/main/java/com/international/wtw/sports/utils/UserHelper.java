...
public class UserHelper {
    ...
    public void setCurrUser(UserModel user) {
        currUser = user;
        SharePreferencesUtil.addString(BaseApplication.getAppContext(), CURRENT_USER, JsonUtil.toJson(user));
    ...
    public UserModel getCurrUser() {
        if (currUser == null) {
            String jsonStr = SharePreferencesUtil.getString(BaseApplication.getAppContext(), CURRENT_USER, null);
