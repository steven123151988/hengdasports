...
import com.international.wtw.sports.activity.first.InfoDetailActivity;
...
public class infoCenterAdaper extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        viewHolder.tv_context = (com.international.wtw.sports.utils.MyTextView) view.findViewById(R.id.tv_context);
    ...
    class ViewHolder {
        TextView tv_time;
        com.international.wtw.sports.utils.MyTextView tv_context;
