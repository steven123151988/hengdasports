...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
    ...
    //水平
    public static final int HORIZONTAL_DIVIDER = RecyclerView.HORIZONTAL;
    //垂直
    public static final int VERTICAL_DIVIDER = RecyclerView.VERTICAL;
    //水平+垂直
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (mOrientation == VERTICAL_DIVIDER) {
            drawVertical(c, parent);
        } else if (mOrientation == HORIZONTAL_DIVIDER) {
